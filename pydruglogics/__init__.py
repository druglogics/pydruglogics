...
if __name__ == '__main__':
    # Interaction
    interaction = InteractionModel(verbosity=2)
    ...
    # ModelOutputs
    model_outputs = ModelOutputs('../ags_cascade_1.0/modeloutputs', verbosity=2)
    # model_outputs_dict = {
    #     "RPS6KA1": 1.0,
    #     "MYC": 1.0,
    #     "TCF7": 1.0,
    ...
    training_data = TrainingData(observations=observations, verbosity=2)
    training_data.print()
    ...
    boolean_model_bnet = BooleanModel(file='../ags_cascade_1.0/network.bnet', model_name='test',
                                      mutation_type='balanced', attractor_tool='mpbn_trapspaces',verbosity=2)
    # boolean_model_bnet.print()

    # BooleanModel init from .sif file
    boolean_model_sif = BooleanModel(model=interaction, model_name='test2',
                                     mutation_type='mixed', attractor_tool='pyboolnet_stable_states', verbosity=2)
    ...
    #     attractor_tool='mpbn_trapspaces'
    # )
